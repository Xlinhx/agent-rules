---
name: polish
description: Elevate good UI to exceptional craft with a meticulous pre-ship polish pass on spacing, contrast, typography, and micro-details.
metadata:
  signals: "polish ui, chuốt lại giao diện, trước khi bàn giao, rà soát chi tiết, pre-ship polish, làm mượt visual"
  excludes: "complete redesign, conceptual overhaul, slides, backend reviews"
  priority: "50"
  platform_scope: "all"
---
