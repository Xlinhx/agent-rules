...
Optional ERP/Admin domain pack. It is **inactive by default** and must be selected explicitly (`domain_pack: "5fedu"` or `--profile 5fedu`). Prompt keywords such as `5fedu`, `drawer`, `listview`, or `ERP` never activate it on their own.
