...
Khi nhận yêu cầu "cài sạch sẽ", "cài lại sạch" hoặc "cài xóa cái cũ": tự động thanh lọc triệt để các thư mục legacy tàn dư, snapshot rollback cũ, và các skill stale trên toàn bộ các host.
